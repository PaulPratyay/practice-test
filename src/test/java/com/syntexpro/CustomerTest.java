...
public class CustomerTest {
    ...
    void testSizeForMeasurement_S() {
        ShopApp.setSizeBasedOnMeasurement(customer, 1);
    ...
    void testSizeForMeasurement_M() {
        ShopApp.setSizeBasedOnMeasurement(customer, 2);
    ...
    void testSizeForMeasurement_L() {
        ShopApp.setSizeBasedOnMeasurement(customer, 3);
    ...
    void testSizeForMeasurement_X() {
        ShopApp.setSizeBasedOnMeasurement(customer, 4);
